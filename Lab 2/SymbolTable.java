...
public class SymbolTable {
    ...
    public boolean add(String key) {
        ...
        while(this.elements[position] != null && i < this.capacity) {
            i++;
    ...
    public int search(String key) {
        ...
        while(!Objects.equals(this.elements[position], key) && i < this.capacity) {
            i++;
            position = this.hashFunction(key, i);
        }
    ...
    private int hashFunction(String key, int i) {
        ...
        return (sumOfASCIICodes % this.capacity + i) % capacity;
    }
}
